      ...
      <div style={{
        ...
        <div style={{
          ...
          <img 
            ...
            alt="Squid Game Logo" 
            style={{ width: '220px', objectFit: 'contain', position: 'relative', zIndex: 5, marginBottom: '20px', background: 'white', padding: '12px', borderRadius: '12px', boxShadow: '0 8px 30px rgba(0,0,0,0.5)' }}
          />
